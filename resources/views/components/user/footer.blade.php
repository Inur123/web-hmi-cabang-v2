            ...
            <div class="lg:col-span-5">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <!-- GANTI TWITTER DENGAN X -->
                        <a href="#"
                            class="group flex items-center justify-center w-10 h-10 bg-gray-800 hover:bg-gradient-to-r hover:from-gray-700 hover:to-black rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-gray-600/50">
