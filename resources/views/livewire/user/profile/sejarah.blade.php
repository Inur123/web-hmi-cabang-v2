                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">Perjalanan organisasi
                                dari
                                masa ke masa</p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <h2
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-6 w-6 sm:h-7 sm:w-7 text-green-600 flex-shrink-0" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        ...
                        <div class="ml-6 sm:ml-8 relative">
                            ...
                            <div
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center gap-2 mb-3">
                                    ...
                                    <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Awal Berdiri
                                    </h3>
                                </div>
                                <p class="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                                    ...
                                    Organisasi ini lahir sebagai respons terhadap kebutuhan akan wadah bagi mahasiswa
                                    muslim
                        ...
                        <div class="ml-6 sm:ml-8 relative">
                            ...
                            <div
                                ...
                                <p class="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                                    ...
                                    gerakan perluasan organisasi untuk menjangkau mahasiswa muslim di wilayah Jawa
                                    Timur.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="ml-6 sm:ml-8 relative">
                            ...
                            <div
                                ...
                                <p class="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                                    HMI Cabang Ponorogo aktif berpartisipasi dalam gerakan reformasi. Organisasi ini
                                    menjadi
                                    salah satu motor penggerak perubahan sosial dan politik di tingkat lokal,
                                    mengadvokasi
