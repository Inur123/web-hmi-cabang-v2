                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div
                        ...
                        <div class="relative h-36 sm:h-40 md:h-48 flex items-center justify-center overflow-hidden"
                            ...
                            <div
                                ...
                                <img src="{{ asset('images/nanda.webp') }}" alt="Nanda Dwi Yanuari"
                        ...
                        <div class="p-4 sm:p-6 text-center">
                            ...
                            <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Nanda
                                Dwi
                                Yanuari</h3>
                    ...
                    <div
                        ...
                        <div class="p-4 sm:p-6 text-center">
                            ...
                            <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Hafidz
                                Aziz
                                Ashwijuwan</h3>
                            <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Universitas Muhammadiyah
                                Ponorogo
                                <span class="font-bold text-green-600 dark:text-green-400">(Alumni)</span>
                            </p>
                            <div class="flex items-center justify-center gap-2 mt-3 sm:mt-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Wasekum
                                                </p>
                                                <p
                                                    class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white">
                                                    Siti Nur Azizah</p>
