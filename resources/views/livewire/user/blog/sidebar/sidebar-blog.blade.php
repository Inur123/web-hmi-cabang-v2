<div class="space-y-4">
    ...
    <!-- Categories Card -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
                ...
                <li>
                    <a href="{{ route('categories.show', $category->slug) }}"
                       ...
                       class="flex items-center text-sm text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 font-medium transition-all duration-300 py-1.5 hover:pl-2 group">
                        <i class="fas fa-angle-right text-xs mr-2 text-gray-400 group-hover:text-green-600 transition-colors"></i>
                        {{ $category->name }}
                    </a>
                </li>
            @endforeach
            ...
            @forelse ($popularPosts as $popularPost)
                <a href="{{ route('blog.show', $popularPost->slug) }}"
                   ...
                   class="flex items-start gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-300 group">
                    ...
                    <!-- Thumbnail -->
                    <div class="w-16 h-16 overflow-hidden rounded-md flex-shrink-0 ring-1 ring-gray-200 dark:ring-gray-600 group-hover:ring-green-500 dark:group-hover:ring-green-400 transition-all duration-300">
                    ...
                    <div class="flex-1 min-w-0">
                        <h4 class="text-sm font-medium text-gray-900 dark:text-white line-clamp-2 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-300 leading-snug mb-1">
                            {{ $popularPost->title }}
                        </h4>
