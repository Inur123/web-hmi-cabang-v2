<!-- filepath: resources/views/livewire/admin/posts/category-index.blade.php -->
<div>
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Kategori Post</h1>
        <p class="text-sm text-gray-600 mt-1">Kelola kategori post</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-4 border-b border-gray-100">
            <h3 class="text-base sm:text-lg font-semibold text-gray-800">Daftar Kategori</h3>
        </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($categories as $index => $category)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="py-3 px-4 text-sm text-gray-700">{{ $categories->firstItem() + $index }}</td>
                            <td class="py-3 px-4">
            ...
            <div class="px-4 py-3 border-t border-gray-100">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="text-sm text-gray-700">
                        ...
                        dari <span class="font-medium">{{ $categories->total() }}</span> hasil
                    </div>
                    <!-- Pagination Buttons -->
                    <div class="flex items-center gap-2">
...
<script>
    function confirmDeleteCategory(id, name) {
        Swal.fire({
            ...
            html: `Kategori <strong>${name}</strong> akan dihapus secara permanen!`,
            icon: 'warning',
